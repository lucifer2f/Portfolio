...
export const Timeline = ({
  ...
  return (
    <div
      className="c-space min-h-screen -mt-20 md:-mt-30"
      ref={containerRef}>
        ...
        {data.map((item, index) => (
          <div key={index} className="flex justify-start pt-10 md:pt-40 md:gap-10">
            <div
              ...
              <div
                className="h-10 absolute w-10 rounded-full -left-[15px]  bg-midnight flex items-center justify-center">
              <div
